...
class DVE_loss_Self_Only(nn.Module):
    def __init__(
        self,
        ...
        super(DVE_loss_Self_Only, self).__init__()
    ...
    def forward(self, feats, meta, epoch, step=0, fname_vis=None, dictionary=None):
        ...
        for b in range(B):
            ...
            f2 = feats2[b].permute(1,0)  # target: rigid transform of source
            fa = f1 # auxiliary
            print("DVE_loss_Self_Only")
